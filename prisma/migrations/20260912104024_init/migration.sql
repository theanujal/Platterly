...
-- CreateIndex
CREATE INDEX "kitchen_organizationId_idx" ON "kitchen"("organizationId");
...
-- AddForeignKey
ALTER TABLE "kitchen" ADD CONSTRAINT "kitchen_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
